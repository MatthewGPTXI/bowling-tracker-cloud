...
function element(id='') {
 ...
 let html='';Object.defineProperty(e,'innerHTML',{get:()=>html,set(v){html=v;e.children=[];if(v.includes('data-field="score"')){e.fields={};for(const field of ['score','openFrames','strikes','strikeOpp','notes','ball']){e.fields[field]=element();e.fields[field].value=field==='strikeOpp'?'10':'';}}}});return e;
}
