...
(async()=>{
 ...
 console.log('PASS: complete sync flow, new uploads, offline/reload retries, earliest-base edit coalescing, conflicting edit protection, unrelated uploads during review, review resolution, no-tap tag-only retries/conflicts/downloads, network failure recovery, account isolation and stale leaderboards.');
